...
const columns = [
  ...
  },
  {
    ...
    render: (text) => {
      return <Link to={`/plm/qat/${text}`}>{text}</Link>;
    },
  },
  {
    title: 'Part Name',
        ...
        <StyledPageHeader
          ...
          extra={[
            <Button key="1" type="primary">
              <Link to="/plm/qat/EAB12345678">New</Link>
            </Button>,
          ]}
        />
        <SearchForm
